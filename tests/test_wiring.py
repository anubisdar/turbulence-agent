...
class TestCountryNamesRatherThanCodes:
    ...
    def test_the_ingest_asks_for_the_name(self):
        """Resolved once during ingest and stored, rather than on every
        page load. The address is still discarded."""
        import importlib.util
        from pathlib import Path
        ...
        assert "resolve_origin" in source
